# 9_4_2 Generative Sprachmodelle - Konzeptmapping (System and User prompt)

## Overview
The folder contains the data and scripts used to perform the concept mapping as part of the method using Large Language Models. The prompts are passed to the model as system and user prompts.

## Folder Structure

- `input/` - contains input files
- `output/` - contains script output
- `results/` - contains various outputs for different models

## Scripts
| Script | Description |
|--------|-------------|
| `script_9_4_2_00_run_llm_mapping` | Runs the pipeline |
| `script_9_4_2_01_ollama_mapping_wurzelkonzepte` | Performs mapping at the root concept level |
| `script_9_4_2_02_ollama_mapping_basiskonzepte` | Performs mapping at the base concept level |
...
5. Run script_9_4_2_00_run_llm_mapping.py to execute the pipeline.