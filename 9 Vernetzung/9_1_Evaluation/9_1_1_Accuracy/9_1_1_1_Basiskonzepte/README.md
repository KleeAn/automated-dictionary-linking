# 9_1_1_1 Accuracy - Basiskonzepte

## Overview
This folder contains the scripts and data for calculating the accuracy of the mapping to the basic concepts (Basiskonzepte).
...
## Script
`script_9_1_1_1_accuracy_basis.py`
...
| File | Description |
|--------|-------------|
|`XXX_accuracy_basis.tsv` | Input file with additional evaluations such as mapping quote, accuracy category |
|`XXX_accuracy_basis_statistk.xlsx` | accuracy statistics |
...
4. Run script_9_1_1_1_accuracy_basis.py to execute the evaluation.