...
# and a combination of system and user prompts.
# ================================================================

from pathlib import Path
from script_9_4_2_01_ollama_mapping_wurzelkonzepte import run_mapping_wurzelkonzepte
from script_9_4_2_02_ollama_mapping_basiskonzepte import run_mapping_basiskonzepte
import time
...
CONFIG = {
    ...
    "json_vocab": Path("input/trinken_vokabular.json"),
    "model_name": "llama3.3:70b", #"deepseek-r1:32b", #"qwen2.5:32b",#"llama3.1:8b", #"qwen2.5:72b", #"llama3.3:70b", #"deepseek-r1:70b"
    "files_to_process": None, # None = all TSVs in input_folder
    "prompts": {
        "wurzelkonzepte": Path("input/wurzelkonzepte_system_prompt_3a.txt"),
        "basiskonzepte": Path("input/basiskonzepte_system_prompt_4b.txt")
    },
...
def run_pipeline(config: dict):
    ...
    root_files = run_mapping_wurzelkonzepte(
        ...
        system_prompt_text=prompt_root
    )
    
    # files for step 2:
    root_files_names = [f.name for f in root_files]
    #root_files_names = ["A_Trinken_llama_wurzelkonzepte.tsv"]
    ...
    files_basis = run_mapping_basiskonzepte(
        ...
        json_path=json_vocab,
        model_name=model_name,
        system_prompt_text=prompt_basis,
    )
