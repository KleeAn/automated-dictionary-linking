# =========================================================================================
# Script 1: Mapping lexical units to Wurzelkonzepte (trinken, Getränk, Durst, kein_Trinken)
...
def run_mapping_wurzelkonzepte(input_folder: Path, output_folder: Path,
                               ...
                               system_prompt_text: str = None) -> list[Path]:

    if system_prompt_text is None:
        raise ValueError("system_prompt_text muss be passed!")
    ...
    for file in files:
        ...
        for xml_id, lemma, pos, definition, concept_gold in entries:
            # generate prompt
            system_prompt = build_system_prompt(system_prompt_text, concept_mapping)
