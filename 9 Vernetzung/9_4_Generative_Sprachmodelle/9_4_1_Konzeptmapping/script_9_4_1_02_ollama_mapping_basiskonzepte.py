# ================================================================
# Script 2: Mapping lexical units to Basiskonzepte with LLM support
# ================================================================
...
# ------------------------------------------------------------
def build_prompt(lemma: str, definition: str, concepts_terms: dict[str, list[str]], prompt_template: str, with_terms: bool = False) -> str:
    concept_list = ""
...
# Purpose: Validate if LLM answer contains allowed concepts; all valid parts are mapped
# ------------------------------------------------------------
...
def run_mapping_basiskonzepte(files: list[str], input_folder: Path,
                              ...
                              prompt_text: str, with_terms: bool = False) -> list[Path]:
    ...
    for file_name in files:
        ...
        for xml_id, lemma, pos, definition, concept_gold, concept_root in entries:
            ...
            prompt = build_prompt(lemma, definition, concept_mapping, prompt_text, with_terms=with_terms)
